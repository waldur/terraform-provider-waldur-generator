...
func attr(name, typ string, required, computed bool, nested ...Attribute) Attribute {
	return Attribute{Name: name, Type: typ, Required: required, Computed: computed, Attributes: nested}
}
...
func TestRemovedEntityIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false))})
...
func TestAddedEntityIsNotBreaking(t *testing.T) {
	...
	nw := manifest(map[string]Entity{"order": res(attr("name", "types.String", true, false))})
	r := Diff(old, nw)
...
func TestRemovedAttributeIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false), attr("plan", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false))})
	r := Diff(old, nw)
...
func TestNewRequiredAttributeIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false), attr("plan", "types.String", true, false))})
	r := Diff(old, nw)
	e := findEntity(t, r, "order")
...
func TestNewOptionalAttributeIsNotBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("name", "types.String", false, false), attr("note", "types.String", false, false))})
	r := Diff(old, nw)
	e := findEntity(t, r, "order")
...
func TestTypeChangeIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("size", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("size", "types.Int64", false, false))})
	r := Diff(old, nw)
	e := findEntity(t, r, "order")
...
func TestOptionalToRequiredIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("plan", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("plan", "types.String", true, false))})
	r := Diff(old, nw)
	e := findEntity(t, r, "order")
...
func TestSettableToComputedIsBreaking(t *testing.T) {
	old := manifest(map[string]Entity{"order": res(attr("plan", "types.String", false, false))})
	nw := manifest(map[string]Entity{"order": res(attr("plan", "types.String", false, true))})
	r := Diff(old, nw)
	e := findEntity(t, r, "order")
...
func TestNestedAttributeChangesAreDetected(t *testing.T) {
	oldNested := attr("mappings", "types.Object", false, false,
		attr("networks", "types.List", false, false),
		attr("subnets", "types.List", false, false),
	)
	newNested := attr("mappings", "types.Object", false, false,
		attr("networks", "types.List", true, false),
	)
...
func TestNoChangesEmpty(t *testing.T) {
	m := manifest(map[string]Entity{"order": res(attr("name", "types.String", true, false))})
	r := Diff(m, m)
...
func TestCommitSubjectAndMarkdown(t *testing.T) {
	old := manifest(map[string]Entity{
		"order": res(attr("name", "types.String", false, false), attr("plan", "types.String", false, false)),
		"gone":  res(attr("x", "types.String", false, false)),
	})
	nw := manifest(map[string]Entity{
		"order": res(attr("name", "types.String", false, false), attr("note", "types.String", false, false)),
		"new":   res(attr("x", "types.String", false, false)),
	})
	r := Diff(old, nw)
